...
<body>
	...
	<section class="listings" style="background-color:#ffffff; border-top: 1px solid #dadada;">
		...
		<div class="slider multiple-items" style="width:36%; margin: 0 auto;">
		...
		<script>
			$('.multiple-items').slick({
			  ...
			  nextArrow: "<img style='position:absolute; right:-60px; top:60px; cursor:pointer' src='<?php bloginfo(stylesheet_directory); ?>/img/next.png'/>"			  	  
			});1
		</script>
	</section>
	...
	<section class="listings" style="background-color:#ffffff; border-top: 1px solid #dadada;">
		...
		<div style="width: 80%; margin: 0 auto;">
				<div class="hero blank btn" style="background: #8e509b; width: 200px; height:30px; line-height:30px; text-align:center; float:left; margin-left: 10%; margin-top: 5px;">
					<span style="color: white; font-family: "lato-bold", Helvetica, Arial, sans-serif; font-size: 16px; font-weight: bold;">ENQUERY</span>
				</div>
				<div class="hero blank btn" style="background: #84509a; width: 200px; height:30px; line-height:30px; text-align:center; float:left; margin-left: 10%; margin-top: 5px;">
				...
				<div class="hero blank btn" style="background: #7f5ca0; width: 200px; height:30px; line-height:30px; text-align:center; float:left; margin-left: 10%; margin-top: 5px;">
