...
<body>
	...
	<section class="listings" style="background-color:#ffffff; border-top: 1px solid #dadada;">
		...
		<div style="width: 80%; margin: 0 auto;">
				<div class="hero blank btn" style="background: #8e509b; width: 200px; height:30px; line-height:30px; text-align:center; float:left; margin-left: 10%;">
					<span style="color: white; font-family: "lato-bold", Helvetica, Arial, sans-serif; font-size: 16px; font-weight: bold;">ENQUERY</span>
				</div>
				<div class="hero blank btn" style="background: #84509a; width: 200px; height:30px; line-height:30px; text-align:center; float:left; margin-left: 10%;">
				...
				<div class="hero blank btn" style="background: #7f5ca0; width: 200px; height:30px; line-height:30px; text-align:center; float:left; margin-left: 10%;">
